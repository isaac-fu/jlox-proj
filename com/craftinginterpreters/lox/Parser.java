...
class Parser {
    ...
    private Stmt forStatement() {
        ...
        // first part of the for loop is either a variable declaration, an expression statement, or nothing
        Stmt initializer;
        if (match(SEMICOLON)) {
            initializer = null;
        } else if (match(VAR)) {
        ...
        // second part of the for loop is the condition, which is an expression or nothing
        Expr condition = null;
        if (!check(SEMICOLON)) {
            condition = expression();
        }
        consume(SEMICOLON, "Expect ';' after loop condition.");
        // third part of the for loop is the increment, which is an expression or nothing
        Expr increment = null;
        if (!check(RIGHT_PAREN)) {
